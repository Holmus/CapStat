...
public class LongestDuelTest {
    ...
    public void testGetStatistics() throws Exception {
        ...
        mrList.add(0, mr);
        LongestDuel ld = new LongestDuel();
        assertTrue(5.0 == ld.getStatistics(mrList, ul.getUserByNickname("DummyOne")).get(0).getValue());
        assertFalse(4.0 == ld.getStatistics(mrList, ul.getUserByNickname("DummyTwo")).get(0).getValue());
