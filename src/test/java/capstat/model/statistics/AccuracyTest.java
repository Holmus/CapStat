...
/**
 * @author Jakob
 * Created by Jakob on 31/05/2015.
 */
public class AccuracyTest {
    ...
    public void testGetStatistics() throws Exception {
        ...
        assertTrue(1.0 == a.getStatistics(mrList, ul.getUserByNickname("DummyOne")).get(0).getValue());
        assertTrue(0.0 == a.getStatistics(mrList, ul.getUserByNickname("DummyTwo")).get(0).getValue());
