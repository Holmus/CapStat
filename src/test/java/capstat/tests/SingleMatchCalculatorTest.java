...
public class SingleMatchCalculatorTest {
    ...
    public void numberOfThrows() {
        ...
        for(SingleMatchCalculator calculcator : smcList) {
            assertEquals("Player 1 has 47 throws", 47, calculcator.getTotalNumberOfThrows(Match.Player.ONE));
            assertEquals("Player 2 has 43 throws", 43, calculcator.getTotalNumberOfThrows(Match.Player.TWO));
